...
// 社交媒体图标组件
const createIcon = (path: string) => styled.svg.attrs({
    viewBox: '0 0 24 24',
        ...
        <BaseInfoContainer>
            ...
            <FriendLinks>
                {links.map((link, index) => (
                    <LinkItem key={index} href={link.url}>{link.text}</LinkItem>
                ))}
            </FriendLinks>
